...
public class ObservableMap<T,R> extends Observable<R> {
    ...
    final com.east.architect_zenghui.architect_31_rxjava3.rxjava.Function<T,R> function;

    public ObservableMap(Observable<T> source, com.east.architect_zenghui.architect_31_rxjava3.rxjava.Function<T, R> function) {
        this.source = source;
