 ...
 */
package com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2;


import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.DELETE;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.FormUrlEncoded;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.GET;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.HEAD;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.HTTP;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Multipart;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.OPTIONS;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.PATCH;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.POST;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.PUT;
import com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Url;
...
final class ServiceMethod<T> {
    ...
    static final class Builder<T> {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            ...
            if (annotation instanceof DELETE) {
                ...
                parseHttpMethodAndPath(http.method(), http.path(),
                        http.hasBody());
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Headers) {
                String[] headersToParse = ((com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Headers) annotation)
                        .value();
        ...
        private ParameterHandler<?> parseParameterAnnotation(int p, Type type,
            ...
            if (annotation instanceof Url) {
            ...
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Path) {
                if (gotQuery) {
                    throw parameterError(p,
                ...
                com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Path path = (com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Path) annotation;
                // 获取 path 的值
            ...
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Query) {
                com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Query query = (com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Query) annotation;
                // 获取值
            ...
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.QueryMap) {
                Class<?> rawParameterType = Utils.getRawType(type);
                ...
                return new ParameterHandler.QueryMap<>(valueConverter,
                        ((com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.QueryMap) annotation).encoded());

            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Header) {
                com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Header header = (com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Header) annotation;
            ...
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.HeaderMap) {
                Class<?> rawParameterType = Utils.getRawType(type);
                if (!Map.class.isAssignableFrom(rawParameterType)) {
                    throw parameterError(p,
            ...
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Field) {
                if (!isFormEncoded) {
                    throw parameterError(p,
                            "@Field parameters can only be used with form encoding.");
                }
                com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Field field = (com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Field) annotation;
            ...
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.FieldMap) {
                if (!isFormEncoded) {
                    throw parameterError(p,
                ...
                return new ParameterHandler.FieldMap<>(valueConverter,
                        ((com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.FieldMap) annotation).encoded());

            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Part) {
                if (!isMultipart) {
                    throw parameterError(p,
                            "@Part parameters can only be used with multipart encoding.");
                }
                com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Part part = (com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Part) annotation;
                gotPart = true;
            ...
            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.PartMap) {
                if (!isMultipart) {
                    throw parameterError(p,
                ...
                com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.PartMap partMap = (com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.PartMap) annotation;
                return new ParameterHandler.PartMap<>(valueConverter,
                        partMap.encoding());

            } else if (annotation instanceof com.east.architect_zenghui.architect16_designmode9_proxy.retrofit2.http.Body) {
