...
import com.east.architect_zenghui.architect2_aop.aop_checknet.CheckNet2;
 ...
 */
@Aspect
public class SectionAspect2 {

    /**
     * 找到处理的切点
     * * *(..)  可以处理所有的方法
     */
    @Pointcut("execution(@com.east.architect_zenghui.architect2_aop.CheckNet2 * *(..))")
    ...
    public Object checkNet(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        CheckNet2 checkNet = signature.getMethod().getAnnotation(CheckNet2.class);
        if (checkNet != null) {
