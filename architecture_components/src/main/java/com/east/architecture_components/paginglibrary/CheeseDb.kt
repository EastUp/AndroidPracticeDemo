...
import com.east.architecture_components.paginglibrary.dao.CheeseDao
import com.east.architecture_components.paginglibrary.entity.Cheese

/**
 * |---------------------------------------------------------------------------------------------------------------|
 *  @description:  PagingLibrary的数据库
 *  @author: East
 *  @date: 2019-08-12
 * |---------------------------------------------------------------------------------------------------------------|
 */
    ...
    companion object {
        ...
        fun getInstance(context: Context): CheeseDb =
            instance ?: synchronized(this) {
                instance ?: Room.databaseBuilder(context.applicationContext, CheeseDb::class.java, "cheeseDataBase")
        ...
        fun fillInDb(context: Context){
            ioThread {
                getInstance(context).cheeseDao().insert(CHEESE_DATA.map {
                    Cheese(id=0,name = it)
                })
            }
        }
