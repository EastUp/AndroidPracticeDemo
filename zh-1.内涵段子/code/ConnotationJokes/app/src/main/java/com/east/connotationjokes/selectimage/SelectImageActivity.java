...
import com.east.framelibrary.util.StatusBarUtil;
...
public class SelectImageActivity extends BaseSkinActivity implements View.OnClickListener, SelectImageListener {
    ...
    protected void initTitle() {
        CommonHeaderBar headerBar = new CommonHeaderBar.Builder(this)
                .setText(R.id.title,"所有图片")
                .create();
        TextView textView = headerBar.getView(R.id.title);
        textView.setVisibility(View.VISIBLE);
        View rl = headerBar.getView(R.id.title_rl);
        rl.setBackgroundColor(Color.parseColor("#261f1f"));
        // 改变状态栏的颜色
