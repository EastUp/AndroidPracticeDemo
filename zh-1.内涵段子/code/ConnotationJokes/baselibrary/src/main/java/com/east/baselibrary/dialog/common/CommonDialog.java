package com.east.baselibrary.dialog.common;
...
public class CommonDialog extends Dialog {
    ...
    public static class Builder{
        ...
        // dialog Key监听
        public Builder setOnKeyListener(@Nullable DialogInterface.OnKeyListener onKeyListener) {
